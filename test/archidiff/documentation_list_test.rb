...
module Archidiff
  class DocumentationListTest < Minitest::Test
    ...
    def test_it_handles_a_result_with_one_document
      doc = Archidiff.parse_xml(PURPOSE)
    ...
    def test_it_handles_a_result_with_two_documents
      doc = Archidiff.parse_xml(ALT_DOCS)
      doc_list = DocumentationList.new(doc.css("purpose"))
    ...
    def test_eql_method
      doc_list1 = DocumentationList.new(Archidiff.parse_xml(PURPOSE).css("purpose"))
      doc_list2 = DocumentationList.new(Archidiff.parse_xml(ALT_DOCS).css("purpose"))
      refute_equal doc_list1, doc_list2

      doc_list3 = DocumentationList.new(Archidiff.parse_xml(PURPOSE).css("purpose"))
