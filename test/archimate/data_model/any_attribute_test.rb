...
module Archimate
  module DataModel
    class AnyAttributeTest < Minitest::Test
      ...
      def setup
        @subject = AnyAttribute.new(attribute: "attr", value: "val", prefix: "pr")
      end

      def test_comparison
        assert_equal %i[attribute prefix value], AnyAttribute.attr_names
      ...
      def test_constructor_with_no_prefix
        subject = AnyAttribute.new(attribute: "attr", value: "val")
      ...
      def test_enumerable
        expected = %i[attribute prefix value]
